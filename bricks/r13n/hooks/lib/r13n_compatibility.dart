...
/// r13n brick.
const _compatibleR13nVersion = '>=0.1.0-dev.1 <0.1.0-dev.3';
...
void ensureRuntimeCompatibility(Directory workingDirectory) {
  ...
  final isCompatible =
      VersionConstraint.parse(_compatibleR13nVersion).allows(version);

  if (!isCompatible) {
    throw R13nCompatibilityException(
      message: '''
The current version of "brick:r13n" requires "package:r13n" $_compatibleR13nVersion.
